...
inline auto countl_zero(unsigned int value) { return __lzcnt(value); }
#ifdef _WIN64
inline auto countl_zero(unsigned __int64 value) { return __lzcnt64(value); }
#endif
...
inline size_t bit_floor(size_t i)
{
    ...
    return size_t(1) << (num_bits - countl_zero(i) - 1);
}
